...
function prototype:CheckFilter(data)
    ...
    if	   (not filter.type[data.type])																								-- type
        ...
        or (data.expires and filter.timemax_min and data.timemax < filter.timemax_min)									-- min timemax
        or (data.expires and filter.timemax_max and data.timemax > filter.timemax_max)									-- max timemax
        or (filter.untilcancelled and ((filter.untilcancelled == "only" and data.expires) or (filter.untilcancelled == "hide" and not data.expires)))
